// by ALIAS
// nul = [obj_pozition,duration] execvm "HavaiFisek\alias_rock.sqf";
...
_poc_sound = _this select 5;
	...
	_ps1 setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal", 16, 7,48,1], "", "Billboard", 1, 0.5+random 1, [0, 0, 0], [0, 0, 0.5], 0, 10.1, 7.9, 0.01, [1, 2, 3], [[0.1,0.1,0.1,0.9], [0.6,0.6,0.6,0.6], [0.8,0.8,0.8,0.4],[0.9,0.9,0.9,0.3],[1,1,1,0.1]], [0.125], 1, 0, "", "", _al_project_temp];
	_ps1 setDropInterval 0.01;
	
	sleep _sunetf;
	_lanspark = "land_helipadempty_f" createVehicle (getPosATL _al_project_temp);
...
//	hint str (getPosATL _al_project_temp select 2);	sleep 1;
	...
	_splah_al setParticleParams [["\A3\data_f\cl_exp", 1, 0, 1], "", "Billboard", 1, 2, [0, 0, 0], [_xx, 0, _zz], 0, 70, 0, 0, [0.5,1], [[_red,_green,_blue, 1],[_red,_green,_blue, 0.5]], [0.08], 1, 0, "", "",_lanspark];
	...
	_poc_mic setParticleParams [["\A3\data_f\cl_exp", 1, 0, 1], "", "Billboard", 1, 2, [0, 0, 0], [0, 0, 0], 0, 70, 0, 0, [0.5,2], [[_red,_green,_blue, 1],[_red,_green,_blue, 0.5]], [0.08], 1, 0, "", "",_lanspark];
