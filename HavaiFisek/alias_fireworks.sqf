...
while {!endf} do {
	...
	_al_project = "Land_Battery_F" createVehicle (getPosASL _obj);
	[_al_project,[_firflut,2000]] remoteExec ["say3d"];
	_al_project setVelocity [0,0,300];
	[[_al_project,_time_life_projectile,_ro,_ve,_bl,_firsound],"HavaiFisek\alias_rock.sqf"] remoteExec ["BIS_fnc_execVM"];
