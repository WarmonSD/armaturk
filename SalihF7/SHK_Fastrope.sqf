...
#define MAX_ALTITUDE_ROPES_AVAIL 150
#define MIN_ALTITUDE_ROPES_AVAIL 20
#define MAX_SPEED_ROPES_AVAIL 55

#define ROPE_LENGTH 75

#define STR_TOSS_ROPES "Halatlari At(MaxYukselik150)"
#define STR_FAST_ROPE "Atla(MaxHizSinir45)"
#define STR_CUT_ROPES "Halatlari Cek"

#define STR_JOIN_QUEUE_HINT "Ipteyken hizlandilar.."
...
SHK_Fastrope_fnc_fastRope = {
  ...
  [_unit,_rope] spawn { // Wait for the unit to be move out of the chopper.
    ...
    if (local _unit) then {
      ...
      _unit switchMove "";
      //detach _unit;
	  #define SAFETY_ZONES [["kavalaguv", 640],["kavalaseftaliguv", 50],["bakirislemeguv", 50],["demirislemeguv", 50],["bakirmadeniguv", 50],["rebelguv", 250],["bagisciguv", 550],["athiraguv", 650],["havalaaniguv1", 400],["havalaaniguv2", 400],["pyrgosguv", 650],["sofiaguv", 450],["adaguv", 700],["bagisciguv_2", 220]]
