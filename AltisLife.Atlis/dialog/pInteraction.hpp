...
class pInteraction_Menu {
    ...
    movingEnable = 0;
    enableSimulation = 1;
    onUnLoad = "if (life_evmenusuactim || (life_pInact_curTarget getVariable ['EvMenusuAcik',false])) then {life_evmenusuactim = false; life_pInact_curTarget setVariable ['EvMenusuAcik',false,true]; };";
    ...
    class controls {
        class ButtonClose: Life_RscButtonMenu {
            ...
            onButtonClick = "if (life_evmenusuactim || (life_pInact_curTarget getVariable ['EvMenusuAcik',false])) then {life_pInact_curTarget setVariable ['EvMenusuAcik',false,true]; life_evmenusuactim = false; closeDialog 0;} else { closeDialog 0; };";
            x = BGX;
            y = 0.8 - (1 / 25) + 0.05;
            w = (6.25 / 40);
            h = (1 / 25);
