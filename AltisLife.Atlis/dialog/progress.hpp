...
class life_cevapla
{
    ...
    fadeout = 1;
    movingEnable = 0;
    onLoad = "uiNamespace setVariable['life_cevapla',_this select 0]";
    objects[] = {};
	class controlsBackground
	{
		class CevaplaButton : Life_RscButtonNativeGamerr
		{
			idc = 954845;
			text = "Gelen Mesaji Cevapla";
			x = 0.406813 * safezoneW + safezoneX;
			y = 0.885122 * safezoneH + safezoneY;
			w = 0.12425 * safezoneW;
